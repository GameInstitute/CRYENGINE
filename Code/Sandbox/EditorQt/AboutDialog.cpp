...
void CAboutDialog::SetVersion(const Version& version)
{
	...
	cry_sprintf(versionText, gettext("Version %d.%d.%d - Build %d"), version[3], version[2], version[1], version[0]);
