...
REGISTER_EDITOR_AND_SCRIPT_COMMAND(Private_EditorCommands::PyHelp, general, help, CCommandDescription(gettext("Go to documentation...")));
REGISTER_EDITOR_UI_COMMAND_DESC(general, help, "", CKeyboardShortcut::StandardKey::HelpWiki, "icons:Tools/Go_To_Documentation.ico");

REGISTER_EDITOR_AND_SCRIPT_COMMAND(Private_EditorCommands::PyZoomIn, general, zoom_in, CCommandDescription(gettext("Zoom In")));
REGISTER_EDITOR_UI_COMMAND_DESC(general, zoom_in, gettext("Zoom In"), CKeyboardShortcut::StandardKey::ZoomIn, "icons:General/Zoom_In.ico");

REGISTER_EDITOR_AND_SCRIPT_COMMAND(Private_EditorCommands::PyZoomOut, general, zoom_out, CCommandDescription(gettext("Zoom Out")));
REGISTER_EDITOR_UI_COMMAND_DESC(general, zoom_out, gettext("Zoom Out"), CKeyboardShortcut::StandardKey::ZoomOut, "icons:General/Zoom_Out.ico");

REGISTER_PYTHON_COMMAND_WITH_EXAMPLE(Private_EditorCommands::PyUndo, general, undo,
	gettext("Undoes the last operation"),
                                     "general.undo()");
...
REGISTER_PYTHON_COMMAND_WITH_EXAMPLE(Private_EditorCommands::PyRedo, general, redo,
	gettext("Redoes the last undone operation"),
                                     "general.redo()");
...
REGISTER_PYTHON_COMMAND_WITH_EXAMPLE(Private_EditorCommands::PyFocusOnLevelEditor, general, focus_level_editor,
	gettext("Brings the level editor window to front"),
...
REGISTER_PYTHON_COMMAND_WITH_EXAMPLE(Private_EditorCommands::PyOpenOrFocusViewPane, general, open_or_focus_pane,
	gettext("Opens an existing view pane specified by the pane class name. If no such pane exists, create it."),
...
REGISTER_PYTHON_ENUM_END
  ...
  REGISTER_PYTHON_COMMAND_WITH_EXAMPLE(Private_EditorCommands::PySetConfigSpec, general, set_config_spec,
	  gettext("Sets the system config spec."),
